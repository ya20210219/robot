...
// キーボードのリピート状態を取得
//=============================================================================
bool Keyboard_IsRepeat(int key)
{
...
//----------------------------------------------
BOOL Mouse_IsLeftPress(void)
{
	return (BOOL)(mouseState.rgbButtons[0] & 0x80);	// 押されたときに立つビットを検査
}
BOOL Mouse_IsLeftTrigger(void)
{
	return (BOOL)(mouseTrigger.rgbButtons[0] & 0x80);
}
BOOL Mouse_IsRightPress(void)
{
	return (BOOL)(mouseState.rgbButtons[1] & 0x80);
}
BOOL Mouse_IsRightTrigger(void)
{
	return (BOOL)(mouseTrigger.rgbButtons[1] & 0x80);
}
BOOL Mouse_IsCenterPress(void)
{
	return (BOOL)(mouseState.rgbButtons[2] & 0x80);
}
BOOL Mouse_IsCenterTrigger(void)
{
	return (BOOL)(mouseTrigger.rgbButtons[2] & 0x80);
}
//------------------
long Mouse_GetMoveX(void)
{
	return mouseState.lX;
}
long Mouse_GetMoveY(void)
{
	return mouseState.lY;
}
long Mouse_GetMoveZ(void)
{
